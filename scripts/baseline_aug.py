...
os.makedirs("../data/result/fsl", exist_ok=True)
...
for seed in range(1,10):
    ...
    support_aug = function.SupportDataset(root_dir='../data/raw/cifar100/data/', transform=augmentation_transform, num_classes=5, support_per_class=1, random_seed=seed)
    ...
    print("Support_aug size: ", len(support_aug))
    print("Query size: ", len(query))
    print("Val size: ", len(val))
    
    # データローダーの作成
    support_loader = DataLoader(support_aug, batch_size=1, shuffle=False)
